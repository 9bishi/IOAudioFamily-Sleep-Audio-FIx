...
protected:
     ...
     *@abstract Called by IOAudioEngine when it has started and resumed from Sleep
     *directly. It is called when an IOAudioEngine has started to send EAPD Verb Command
     * for enabling audio from Speakers and also during IOAudioEngine resumed audio stream
     * from sleep to resume audio from Speakers by sending EAPD Verb command.
     */
    static void EAPDVerbUpdate();
};
